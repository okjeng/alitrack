...
import { getLocalWishlist, toggleLocalWish, fmt } from "../utils.js";
import { IconBack } from "../components/ui/index.jsx";
import { EmptyWishlist } from "../components/EmptyStates.jsx";

export const LocalWishlistScreen = ({ onBack, onGoHome, onProduct, showToast }) => {
