...
import { getPriceHistory, generateHistory, idToSeed, getLocalAlerts, removeLocalAlert, fmt } from "../utils.js";
import { API_BASE } from "../data/constants.js";
import { IconBack } from "../components/ui/index.jsx";
import { PriceHistoryItem, BollingerSavingsChart } from "../components/PriceHistoryItem.jsx";
import { EmptyPriceHistory } from "../components/EmptyStates.jsx";
import { AlertModal } from "../modals/AlertModal.jsx";

export const PriceHistoryScreen = ({ onBack, onScrollToProducts, onProduct, showToast }) => {
  ...
  }, [raw.map(r => r.productId).join(",")]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <div className="bg-[#F7F7F8] min-h-screen">
      ...
      <div className="px-4 pt-2 pb-6 space-y-2">
        {hist.map(item => (
          <PriceHistoryItem key={item.productId} item={item} onDetail={onProduct} />
        ))}
