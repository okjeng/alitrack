...
import { fmt, idToSeed, generateHistory, buildAffiliateUrl, toggleLocalWish, getLocalWishlist, getLocalAlerts, savePriceHistory, trackEvent } from "../utils.js";
import { TAG_COLORS, NAV_H, BTN_H } from "../data/constants.js";
import { IconBack, LegalFooter } from "../components/ui/index.jsx";
import { PriceRangeChart } from "../components/charts/PriceRangeChart.jsx";
import { WeeklyPatternCard } from "../components/charts/WeeklyPatternCard.jsx";
import { NextSaleCountdown } from "../components/charts/NextSaleCountdown.jsx";
import { PriceTimeline } from "../components/charts/PriceTimeline.jsx";
import { SellerCompareCard } from "../components/charts/SellerCompareCard.jsx";
import { ShareSheet } from "../modals/ShareSheet.jsx";
import { AlertModal } from "../modals/AlertModal.jsx";

export const DetailScreen = ({ product, onBack, showLogin, showToast, user }) => {
