...
interface HowToUseScreenProps { onBack: () => void; }

export const HowToUseScreen = ({ onBack }: HowToUseScreenProps) => {
  const steps = [
    {
  ...
  const colorMap: Record<string, { bg:string; ring:string; badge:string; pill:string; text:string }> = {
  ...
  const tipColor: Record<string, string> = { blue:"bg-blue-100 text-blue-600", purple:"bg-purple-100 text-purple-600", emerald:"bg-emerald-100 text-emerald-600" };
