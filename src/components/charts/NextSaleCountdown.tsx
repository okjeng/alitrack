...
import { calcNextSale } from "./helpers";

interface NextSaleCountdownProps { currentPrice: number; }

export const NextSaleCountdown = ({ currentPrice }: NextSaleCountdownProps) => {
