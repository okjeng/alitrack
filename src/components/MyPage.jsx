...
import { getGuestId, getLocalAlerts, getLocalWishlist } from "../utils.js";

export const GuestMypage = ({ onLogin }) => {
...
export const EmptyMypage = ({ onLogin }) => <GuestMypage onLogin={onLogin} />;

export const LoggedInMypage = ({ user, onLogout }) => {
...
export const NotificationSettingsSheet = ({ onClose }) => {
